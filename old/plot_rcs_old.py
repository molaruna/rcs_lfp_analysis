...
def plot_rcs(dir_name, step_size):
    """
    Parameters
    ----------
    dir_name : parent directory of the "Sessions" folders to process
    step_size : int, amount of seconds for each PSD

    Returns
    -------
    power spectra plots in input directory within the "plots" folder
    """
